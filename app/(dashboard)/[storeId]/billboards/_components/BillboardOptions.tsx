...
import RemoveBillboardModal from "./RemoveBillboardModal";

type BillboardOptionsProps = {
  billboardId: string;
};

export default function BillboardOptions({
  billboardId,
}: BillboardOptionsProps) {
  ...
  const copyHandler = () => {
    ...
    toast.success("آی دی بیلبورد کپی شد");
    handleClose();
  };
